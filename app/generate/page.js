...
export default function Generate(){
    ...
    const [flashcards, setFlashcards] = useState([]) // Correct use of useState
    const [flipped, setFlipped] = useState([]) // Correct use of useState
    const [text, setText] = useState('') // Correct use of useState
    const [name, setName] = useState('') // Correct use of useState
    const [open, setOpen] = useState(false) // Correct use of useState
    ...
    <Container maxWidth="md">
                                    ...
                                    <CardContent>
                                        <Box sx={{
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    <Typography variant="body1" component="div">{flashcard.back}</Typography>
                                                </div>
                                            </div>
                                        </Box>
                                    </CardContent>
        ...
        <Dialog open={open} onClose={handleClose}>
            <DialogTitle>Save CareerCards</DialogTitle>
            <DialogContent>
                <DialogContentText>
                    Enter the name of your Careercards collection
                </DialogContentText>
                <TextField
                    autoFocus
                    margin="dense"
